...
static inline long    atol(const char *s)                 { return (long)str_to_long(s, NULL, 10); }
static inline double  atof(const char *s)                 { return str_to_double(s, NULL); }
static inline long    strtol(const char *s, char **e, int b)  { return str_to_long(s, e, b); }
static inline unsigned long strtoul(const char *s, char **e, int b) { return str_to_ulong(s, e, b); }
static inline double  strtod(const char *s, char **e)     { return str_to_double(s, e); }
...
static inline char *itoa(int v, char *buf, int base) {
    if (base == 10) { int_to_str(v, buf); return buf; }
    if (base == 16) { uint32_to_hex_str((uint32_t)v, buf, false); return buf; }
