...
static inline bool color_is_bright(uint8_t c) {
    return c >= DARK_GRAY;
}

static inline uint8_t color_invert(uint8_t c) {
    return (uint8_t)(c ^ 8);
}
