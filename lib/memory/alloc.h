...
static inline bool pool_empty(const pool_t *pool) { return pool->free_count == 0; }
static inline uint32_t pool_available(const pool_t *pool) { return pool->free_count; }
