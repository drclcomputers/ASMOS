...
static inline widget make_label(int x, int y, char *text, unsigned char color,
                                int font_size) {
    widget wg = {0};
...
static inline widget make_checkbox(int x, int y, char *label, unsigned char bg,
                                   unsigned char fg, unsigned char border,
...
static inline widget make_textbox(int x, int y, int w, int h, unsigned char bg,
                                  unsigned char fg, unsigned char border) {
    widget wg = {0};
...
static inline widget make_dropdown(int x, int y, int w, int h, unsigned char bg,
                                   unsigned char fg, unsigned char border,
...
static inline widget make_vscrollbar(int x, int y, int h, unsigned char bg,
                                     unsigned char fg, unsigned char border,
                                     int max, int viewport,
                                     WidgetCallback on_change) {
    widget wg = {0};
...
static inline widget make_hscrollbar(int x, int y, int w, unsigned char bg,
                                     unsigned char fg, unsigned char border,
                                     int max, int viewport,
                                     WidgetCallback on_change) {
    widget wg = {0};
